...
export class ClienteDominioController {
  ...
  async find(
    ...
    return this.clienteRepository.dominios(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.dominios(id).create(dominio);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.dominios(id).patch(dominio, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.dominios(id).delete(where);
  }
}
