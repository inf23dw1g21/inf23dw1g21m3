...
export class ClientePagamentoController {
  ...
  async find(
    ...
    return this.clienteRepository.pagamentos(id).find(filter);
  }
  ...
  async create(
    ...
    return this.clienteRepository.pagamentos(id).create(pagamento);
  }
  ...
  async patch(
    ...
    return this.clienteRepository.pagamentos(id).patch(pagamento, where);
  }
  ...
  async delete(
    ...
    return this.clienteRepository.pagamentos(id).delete(where);
  }
}
