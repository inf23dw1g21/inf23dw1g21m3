...
export class PlanoClienteController {
  ...
  async find(
    ...
    return this.planoRepository.clientesPlano(id).find(filter);
  }
  ...
  async create(
    ...
    return this.planoRepository.clientesPlano(id).create(cliente);
  }
  ...
  async patch(
    ...
    return this.planoRepository.clientesPlano(id).patch(cliente, where);
  }
  ...
  async delete(
    ...
    return this.planoRepository.clientesPlano(id).delete(where);
  }
}
